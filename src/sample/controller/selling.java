    ...
    */
    ...
    public void  updateUnitPrice(){
        ...
        try {
            ...
            while (dbResAllTotal.next()) {
                if (quantity.equals(dbResAllTotal.getString("Bname"))){iprice.setText(String.valueOf(dbResAllTotal.getDouble("Bprice")));}
                else if (quantity.equals(dbResAllTotal.getString("Aname"))){iprice.setText(String.valueOf(dbResAllTotal.getDouble("Aprice")));}
            }
            updatePrice();
        }catch (Exception e){
            e.getCause();
